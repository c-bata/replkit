...
use prompt_core::console::EventLoopError;
...
impl WindowsVtConsoleInput {
    ...
    fn setup_vt_mode(&self) -> io::Result<()> {
        unsafe {
            ...
            let vt_mode = vt_mode & !(ENABLE_LINE_INPUT | ENABLE_ECHO_INPUT | ENABLE_PROCESSED_INPUT | ENABLE_QUICK_EDIT_MODE);
...
impl ConsoleInput for WindowsVtConsoleInput {
    ...
    fn start_event_loop(&self) -> ConsoleResult<()> {
        ...
        if self.event_loop_state.compare_exchange(
        ...
        self.event_loop_state.store(EventLoopState::Running as u8, Ordering::Relaxed);
    ...
    fn stop_event_loop(&self) -> ConsoleResult<()> {
        ...
        self.event_loop_state.store(EventLoopState::Stopping as u8, Ordering::Relaxed);
        ...
        // Mark as stopped
        self.event_loop_state.store(EventLoopState::Stopped as u8, Ordering::Relaxed);
